...
class Save extends \Nisl\First\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('nisl_first/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('nisl_first/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('nisl_first/*/new');
                }
                return;
            } catch (\Exception $e) {
